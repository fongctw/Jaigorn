...
from .views import (
    CustomerPayView, UnpaidBillListView, RepayBillAPIView,
    CreditSummaryView, HomeBillListView, TransactionHistoryView,
    MyTransactionHistoryView, GenericSpendView
)
app_name = 'wallets'
...
urlpatterns = [
    ...
    path(
        'me/generic-spend/',
        GenericSpendView.as_view(),
        name='wallet-generic-spend'
    ),
